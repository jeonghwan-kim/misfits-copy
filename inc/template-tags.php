...
function twentyfifteen_entry_meta() {
	...
	if ( in_array( get_post_type(), array( 'post', 'attachment' ) ) ) {
		...
		printf( '<span class="posted-on"><span class="screen-reader-text"><a href="%1$s" rel="bookmark"><i class="fa fa-clock-o"></i> </span>%2$s</a></span>&ensp;&ensp;&ensp;',
	...
	if ( ! is_single() && ! post_password_required() && ( comments_open() || get_comments_number() ) ) {
		...
		comments_popup_link( '<i class="fa fa-comments-o"></i> 0', '<i class="fa fa-comments-o"></i> 1', '<i class="fa fa-comments-o"></i> %' );
		echo '</span>';
	}
}
endif;
